...
class StateBucket:
    ...
    def has_mapping(self, entity_id: str) -> bool:
        """True iff this entity is mapped in the current blueprint. Used by
        the live tee in main.py to skip forwarding HA internals like sun.sun
        or device_tracker.* that the operator hasn't asked us to surface."""
        return entity_id in self._lookup
